...
;(function($) {
  ...
  $.extend($.facybox, {
	...
	getViewport: function() {
		//  [1009, 426, 0, 704]
		$('#width').val('['+$(window).width()+','+ $(window).height()+','+ $(window).scrollLeft()+','+ $(window).scrollTop()+']') ;
  ...
  function preloadImages(){
	...
	var img = new Image();
	img.src = 'http://youwuku.cn/egou/images/common/loading-32x32.gif';
  }
