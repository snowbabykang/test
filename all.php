...
<html>
 	<head> 
  		...
  		<meta charset="utf-8" /> 
  		<title>优物库商家后台</title> 
 		<link rel="stylesheet" type="text/css" href="http://youwuku.cn/egou/public/css/style_20170905.css" /> 
	<style>
...
<body> 
<div class="app-body" style="top:0;"> <div class="container_box"> <div class="col_main" style="top:0;left:0;">
<div class="col_main_con"> 	
									...
									<table class="table">
            							...
            							<tr>
            								...
            								<td>
            									...
            									<a href="javascript:void(0);"><i class="ywkicon icon-questioncircle ask" data-toggle="popover" data-content="百分比设定的是按照商品最终成交价返利" ></i></a>
            								</td>
            							</tr>
            							<?php } ?>
            						</table>
...
<script type="text/javascript" src="http://youwuku.cn/egou/public/js/baseinclude.js"></script>
...
function nofind(str){
    ...
    img.src = str || "http://youwuku.cn/egou/uwkui/dist/img/none.png";
    img.onerror = null;
}
